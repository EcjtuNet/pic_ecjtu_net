...
<h2>
<div class="ico_cate"></div>图集管理 <input onclick="window.location.href='<?php echo site_url('admin/posts/post_add');?>'" type="button" class="btn" value="新增图集" style="position: absolute; left: 200px; top: 60px;" />
<div id="search">
...
<?php endforeach;?>
<span class="check">
	<?php echo anchor('admin/posts/post_check/','等待审核('.$wait_check_num.')'); ?>
</span>
</div>
</h2>
<table class="tablelist">
  ...
  <tr align="center">
    ...
    <td><?php echo $row['posts_author']; ?></td>
